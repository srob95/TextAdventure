...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void LoadResources() {
        if (locations.isEmpty()) {
            ...
            Item greenGem = new Item(new String[]{"1"}, "Green Gem", "A Lovely Emerald Colour.");
            Item magicCandle = new Item(new String[]{"2"}, "Magic Candle of the Cursed Flame", "It seems like just a candle.");
            Item redGem = new Item(new String[]{"3"}, "Red Gem", "A Lovely Ruby Colour.");
            Item purpleGem = new Item(new String[]{"4"}, "Purple Gem", "A Lovely Purple Colour.");
            Item bedroomKey = new Item(new String[]{"5"}, "Bedroom Key", "A Simple Key.");
            Item holygem = new Item(new String[]{"6"}, "Holy Gem", "The Ultimate Treasure.");
